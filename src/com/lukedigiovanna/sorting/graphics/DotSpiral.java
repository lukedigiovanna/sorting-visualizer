...
public class DotSpiral implements Visualizer {
	@Override
	public void draw(BufferedImage screen, Array array, ColorLoop colorLoop) {
		...
		for (int i = 0; i < array.size(); i++) {
			...
			int smallRadius = (int)((double)array.get()[i]/array.size() * radius);
			g.fillOval((int)(cx + smallRadius * Math.cos(startAngle)), (int)(cy + smallRadius * Math.sin(startAngle)), 10, 10);
		}
	}
}
